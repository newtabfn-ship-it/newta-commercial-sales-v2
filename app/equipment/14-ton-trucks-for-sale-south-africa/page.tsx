...
export default async function FourteenTonTrucksForSaleSouthAfrica() {
  ...
  const fourteenTonTrucks = commercialVehicles?.subcategories.find(
    (subcategory) => subcategory.slug === "14-ton-trucks"
  );
