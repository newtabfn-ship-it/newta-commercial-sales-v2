...
const pageUrl =
  "https://newtacommercialsales.com/equipment/2-ton-trucks-for-sale-south-africa";

export const metadata: Metadata = {
  title: "2 Ton Trucks for Sale South Africa | NEWTA Commercial Sales",

  description:
    "Browse 2 ton trucks for sale in South Africa through NEWTA Commercial Sales. View available commercial trucks including dropside, flatdeck and other 2 ton trucks offered through Private Treaty Sales.",
  ...
  openGraph: {
    ...
    description:
      "Browse 2 ton trucks for sale in South Africa through NEWTA Commercial Sales.",
...
export default async function TwoTonTrucksForSaleSouthAfrica() {
  await connectDB();
  ...
  const twoTonTrucks = commercialVehicles?.subcategories.find(
    (subcategory) => subcategory.slug === "2-ton-trucks"
  );

  const equipment = await Equipment.find({
    category: "Commercial Vehicles",
    subcategory: twoTonTrucks?.name,
    status: "Available",
  })
    .sort({ createdAt: -1 })
    .lean();
  ...
  const structuredData = {
    ...
    name: "2 Ton Trucks for Sale South Africa",

    description:
      "2 ton commercial trucks for sale through NEWTA Commercial Sales.",
        ...
        <section className="bg-gradient-to-r from-green-950 via-green-900 to-green-800 text-white">
          ...
          <div className="mx-auto max-w-7xl px-6 py-20">
            ...
            <h1 className="mt-6 max-w-4xl text-4xl font-extrabold leading-tight md:text-6xl">
              2 Ton Trucks for Sale South Africa
            </h1>

            <p className="mt-6 max-w-4xl text-lg leading-8 text-gray-200 md:text-xl">
              Browse 2 ton trucks for sale in South Africa through
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="max-w-4xl">
            ...
            <h2 className="text-3xl font-bold text-[#0B2F24] md:text-4xl">
              2 Ton Trucks for Sale
            </h2>

            <p className="mt-5 text-lg leading-8 text-gray-600">
              View current 2 ton truck listings available through
          ...
          {equipment.length > 0 ? (
            ...
            <div className="mt-12 rounded-2xl border bg-white p-10 text-center shadow-sm">
              ...
              <h2 className="text-2xl font-bold text-[#0B2F24]">
                No 2 Ton Trucks Currently Available
              </h2>

              <p className="mt-3 text-gray-600">
                We do not currently have a 2 ton truck listed for
        ...
        <section className="border-t bg-white">
          ...
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <p className="mt-4 max-w-4xl text-lg leading-8 text-gray-600">
              Depending on availability, 2 ton trucks may be available
        ...
        <section className="bg-[#FAF8F2]">
          ...
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <div className="max-w-4xl">
              ...
              <p className="mt-5 text-lg leading-8 text-gray-600">
                2 ton trucks are commercial vehicles designed for
                transporting lighter loads while offering greater
                carrying capacity than smaller delivery vehicles.
                They are commonly used by businesses that require
                practical transport for local deliveries, materials,
                equipment and general freight.
              </p>

              <p className="mt-5 text-lg leading-8 text-gray-600">
                The body configuration, vehicle specification and
                permitted payload can vary between individual trucks.
                Buyers should always check the specifications and
                documentation of the individual vehicle before
                purchase.
              </p>
        ...
        <section className="border-t bg-[#FAF8F2]">
          ...
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              {[
                ["3 Ton Trucks", "/equipment/3-ton-trucks-for-sale-south-africa"],
                ["4 Ton Trucks", "/equipment/4-ton-trucks-for-sale-south-africa"],
                ["8 Ton Trucks", "/equipment/8-ton-trucks-for-sale-south-africa"],
                ["10 Ton Trucks", "/equipment/10-ton-trucks-for-sale-south-africa"],
                ["12 Ton Trucks", "/equipment/12-ton-trucks-for-sale-south-africa"],
        ...
        <section className="bg-[#0B2F24] text-white">
          ...
          <div className="mx-auto max-w-7xl px-6 py-16 text-center">
            ...
            <h2 className="text-3xl font-bold md:text-4xl">
              Looking for a 2 Ton Truck?
            </h2>

            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300">
              If you are looking for a particular 2 ton truck, body
