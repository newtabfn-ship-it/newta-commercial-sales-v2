...
export const metadata: Metadata = {
  title:
    "Dropside Trucks for Sale South Africa | NEWTA Commercial Sales",

  description:
    "Browse dropside trucks for sale in South Africa through NEWTA Commercial Sales. Find available dropside trucks, 2 ton, 3 ton, 4 ton and larger commercial trucks with specifications, photographs, pricing and enquiry information.",

  alternates: {
    canonical:
      "https://newtacommercialsales.com/equipment/dropside-trucks-for-sale-south-africa",
  },
  ...
  openGraph: {
    ...
    description:
      "Browse dropside trucks currently available through NEWTA Commercial Sales across South Africa. View truck specifications, photographs, pricing and enquiry information.",
  ...
  twitter: {
    ...
    description:
      "Browse available dropside trucks through NEWTA Commercial Sales across South Africa.",
  },
};

export default async function DropsideTrucksPage() {
  await connectDB();
  ...
  const dropsideTrucks = commercialVehicles?.subcategories.find(
    (subcategory) => subcategory.slug === "dropside-trucks"
  );

  const equipment = await Equipment.find({
    category: commercialVehicles?.name,
    subcategory: dropsideTrucks?.name,
    status: "Available",
  })
    .sort({ createdAt: -1 })
    .lean();
  ...
  const structuredData = {
    ...
    name: "Dropside Trucks for Sale South Africa",

    description:
      "Dropside trucks for sale through NEWTA Commercial Sales across South Africa.",
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="max-w-4xl">
            ...
            <h2 className="text-3xl font-bold text-[#0B2F24] md:text-4xl">
              Dropside Trucks for Sale
            </h2>

            <p className="mt-5 text-lg leading-8 text-gray-600">
              NEWTA Commercial Sales offers commercial vehicles
              through Private Treaty Sales. Our dropside truck
            ...
            <p className="mt-5 text-lg leading-8 text-gray-600">
              Dropside trucks are available in different sizes and
              payload capacities, making them suitable for a wide
              range of transport, delivery, construction and
              commercial applications. Browse the current listings
              below to find an available truck.
            </p>
          ...
          {equipment.length > 0 ? (
            ...
            <div className="mt-12 rounded-2xl border bg-white p-10 text-center shadow-sm">
              ...
              <h2 className="text-2xl font-bold text-[#0B2F24]">
                No dropside trucks currently available
              </h2>

              <p className="mt-3 text-gray-600">
                Please check back soon for new dropside truck
                listings.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <p className="mt-3 text-gray-600">
                  NEWTA Commercial Sales can offer dropside trucks
                  in a range of sizes and payload capacities,
              ...
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <p className="mt-3 text-gray-600">
                  ...
                  about an available dropside truck and receive
        ...
        <section className="bg-[#FAF8F2]">
          ...
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <p className="mt-4 max-w-3xl text-lg text-gray-600">
              Looking for another type of commercial truck?
        ...
        <section className="bg-[#0B2F24] text-white">
          ...
          <div className="mx-auto max-w-7xl px-6 py-16 text-center">
            ...
            <h2 className="text-3xl font-bold md:text-4xl">
              Looking for a Dropside Truck?
            </h2>

            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300">
              Contact NEWTA Commercial Sales if you are looking
              for a particular dropside truck or want more
