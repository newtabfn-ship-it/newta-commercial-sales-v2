...
export const metadata: Metadata = {
  title: "Other Trucks for Sale South Africa | NEWTA Commercial Sales",

  description:
    "Browse Other Trucks for sale in South Africa through NEWTA Commercial Sales. View available Other Trucks, specifications, images, pricing and enquiry information.",
  ...
  openGraph: {
    ...
    description:
      "Browse Other Trucks currently available through NEWTA Commercial Sales across South Africa.",
...
export default async function OtherTrucksForSalePage() {
  ...
  const structuredData = {
    ...
    description:
      "Other Trucks for sale through NEWTA Commercial Sales.",
