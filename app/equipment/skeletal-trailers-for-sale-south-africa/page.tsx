...
const pageUrl =
  "https://newtacommercialsales.com/equipment/skeletal-trailers-for-sale-south-africa";

export const metadata: Metadata = {
  title: "Skeletal Trailers for Sale South Africa | NEWTA Commercial Sales",

  description:
    "Skeletal trailers for sale in South Africa through NEWTA Commercial Sales. Browse available Skeletal trailers are used for transporting containers.",
  ...
  openGraph: {
    ...
    description:
      "Browse Skeletal trailers for sale through NEWTA Commercial Sales.",
  ...
  twitter: {
    ...
    description:
      "Browse available Skeletal trailers through NEWTA Commercial Sales.",
  },
};

export default async function SkeletalTrailersForSalePage() {
  await connectDB();
  ...
  /*
   * Skeletal trailers may eventually have their own category in
  ...
  const SkeletalEquipment = equipment.filter((item: any) => {
    ...
    return searchableText.includes("Skeletal");
  });
  ...
  const structuredData = {
    ...
    name: "Skeletal Trailers for Sale South Africa",

    description:
      "Skeletal trailers for sale through NEWTA Commercial Sales.",
    ...
    mainEntity: {
      ...
      numberOfItems: SkeletalEquipment.length,

      itemListElement: SkeletalEquipment.map((item: any, index: number) => ({
        "@type": "ListItem",
      ...
      <main className="min-h-screen bg-[#FAF8F2]">
        ...
        <section className="bg-gradient-to-r from-green-950 via-green-900 to-green-800 text-white">
          <div className="mx-auto max-w-7xl px-6 py-20">
            ...
            <h1 className="mt-6 max-w-5xl text-4xl font-extrabold leading-tight md:text-6xl">
              Skeletal Trailers for Sale South Africa
            </h1>

            <p className="mt-6 max-w-4xl text-lg leading-8 text-gray-200 md:text-xl">
              Browse Skeletal trailers for sale through NEWTA
              Commercial Sales. Skeletals are used for transporting  containers.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          <div className="max-w-4xl">
            <h2 className="text-3xl font-bold text-[#0B2F24] md:text-4xl">
              Skeletal Trailers for Sale
            </h2>

            <p className="mt-5 text-lg leading-8 text-gray-600">
              Skeletal trailers are specialised commercial trailers designed
              primarily for transporting shipping containers. Their chassis-style
              design provides a practical platform for carrying containers between
              ports, depots, distribution centres and other commercial locations.
            </p>

            <p className="mt-5 text-lg leading-8 text-gray-600">
              Skeletal trailers can be configured for different container
              transport applications, including common container lengths and
              mounting arrangements. The exact container capacity, dimensions and
              specifications depend on the individual trailer.
            </p>
          ...
          <div className="mt-14">
            <h2 className="text-3xl font-bold text-[#0B2F24]">
              Common Uses for Skeletal Trailers
            </h2>

            <p className="mt-4 max-w-3xl text-lg leading-8 text-gray-600">
              Port & Depot Operations
              Their chassis-style configuration makes them practical for moving containers between
              ports, depots, distribution centres and commercial sites.
            </p>

            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
               "20 ft container transport",
               "40 ft container transport",
               "Port and depot movements",
               "Container logistics",
        ...
        <section className="border-y bg-white">
          <div className="mx-auto max-w-7xl px-6 py-16">
            <div className="max-w-4xl">
              <h2 className="text-3xl font-bold text-[#0B2F24] md:text-4xl">
                Skeletal Trailer Configurations
              </h2>

              <p className="mt-5 text-lg leading-8 text-gray-600">
                Skeletal trailers are available in different
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2">
              <div className="rounded-2xl border bg-[#FAF8F2] p-7 shadow-sm">
                ...
                <p className="mt-4 leading-7 text-gray-600">
                  They are commonly used for transporting containers.
                </p>
              </div>
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          <div className="max-w-4xl">
            <h2 className="text-3xl font-bold text-[#0B2F24] md:text-4xl">
              Skeletal Trailers Currently Available
            </h2>
          ...
          {SkeletalEquipment.length > 0 ? (
            <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {SkeletalEquipment.map((item: any) => (
                <EquipmentCard
            ...
            <div className="mt-12 rounded-2xl border bg-white p-10 text-center shadow-sm">
              <h2 className="text-2xl font-bold text-[#0B2F24]">
                No Skeletal trailers currently available
              </h2>

              <p className="mt-3 text-gray-600">
                Please check back soon for new Skeletal trailer
                listings.
              </p>
        ...
        <section className="bg-[#FAF8F2]">
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <Link
                href="/equipment/Skeletal-trailers-for-sale-south-africa"
                className="rounded-2xl border bg-white p-6 font-bold text-[#0B2F24] shadow-sm transition hover:-translate-y-1 hover:border-[#D4AF37]"
              >
                Flatdeck Trailers →
              </Link>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <p className="mt-3 leading-7 text-gray-600">
                  Skeletal trailers are specialised commercial trailers designed
                  primarily for transporting shipping containers.
                </p>
              </div>
              ...
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <p className="mt-3 leading-7 text-gray-600">
                  Skeletal trailers can be found in different
              ...
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <p className="mt-3 leading-7 text-gray-600">
                  ...
                  available Skeletal trailer or another commercial
                  asset.
                </p>
              </div>
            </div>
        ...
        <section className="bg-[#0B2F24] text-white">
          <div className="mx-auto max-w-7xl px-6 py-16 text-center">
            <h2 className="text-3xl font-bold md:text-4xl">
              Looking for a Skeletal Trailer?
            </h2>

            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300">
              Contact NEWTA Commercial Sales if you are looking for a
              particular Skeletal trailer or want more information
