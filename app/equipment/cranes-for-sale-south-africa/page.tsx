...
export const metadata: Metadata = {
  title: "Cranes for Sale South Africa | NEWTA Commercial Sales",

  description:
    "Browse cranes for sale in South Africa through NEWTA Commercial Sales. View available cranes, lifting equipment, specifications, images, pricing and enquiry information.",

  alternates: {
    canonical:
      "https://newtacommercialsales.com/equipment/cranes-for-sale-south-africa",
  },

  openGraph: {
    title: "Cranes for Sale South Africa | NEWTA Commercial Sales",
    description:
      "Browse cranes and lifting equipment currently available through NEWTA Commercial Sales across South Africa.",
    url:
      "https://newtacommercialsales.com/equipment/cranes-for-sale-south-africa",
    type: "website",
  ...
  twitter: {
    ...
    title: "Cranes for Sale South Africa | NEWTA Commercial Sales",
    description:
      "Browse available cranes and lifting equipment through NEWTA Commercial Sales.",
  },
};

export default async function CranesForSalePage() {
  await connectDB();
  ...
  const cranes = plantMachinery?.subcategories.find(
    (subcategory) => subcategory.slug === "cranes"
  );

  const equipment = await Equipment.find({
    category: plantMachinery?.name,
    subcategory: cranes?.name,
    status: "Available",
  })
    .sort({ createdAt: -1 })
    .lean();
  ...
  const structuredData = {
    ...
    name: "Cranes for Sale South Africa",

    description:
      "Cranes and lifting equipment for sale through NEWTA Commercial Sales.",
        ...
        <section className="bg-gradient-to-r from-green-950 via-green-900 to-green-800 text-white">
          <div className="mx-auto max-w-7xl px-6 py-20">
            ...
            <p className="mt-6 max-w-4xl text-lg leading-8 text-gray-200 md:text-xl">
              Browse cranes and lifting equipment currently available
              through NEWTA Commercial Sales. View specifications,
              photographs, pricing and enquiry information for
              available equipment across South Africa.
            </p>
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="max-w-4xl">
            <h2 className="text-3xl font-bold text-[#0B2F24] md:text-4xl">
              Cranes & Lifting Equipment for Sale
            </h2>

            <p className="mt-5 text-lg leading-8 text-gray-600">
              Browse current crane and lifting equipment listings
              available through NEWTA Commercial Sales. Each listing
              provides available specifications, photographs, pricing
          ...
          {equipment.length > 0 ? (
            ...
            <div className="mt-12 rounded-2xl border bg-white p-10 text-center shadow-sm">
              <h2 className="text-2xl font-bold text-[#0B2F24]">
                No cranes currently available
              </h2>

              <p className="mt-3 text-gray-600">
                Please check back soon for new crane listings.
              </p>
        ...
        <section className="border-t bg-white">
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <p className="mt-5 max-w-4xl text-lg leading-8 text-gray-600">
              NEWTA Commercial Sales provides access to cranes and
              lifting equipment available through Private Treaty Sales.
              Browse current listings or contact us if you are looking
              for a specific type of crane.
            </p>
        ...
        <section className="bg-[#0B2F24] text-white">
          <div className="mx-auto max-w-7xl px-6 py-16 text-center">
            ...
            <h2 className="text-3xl font-bold md:text-4xl">
              Looking for a Specific Crane?
            </h2>

            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300">
              Contact NEWTA Commercial Sales if you are looking for
              a particular crane or want more information about an
              available asset.
            </p>
