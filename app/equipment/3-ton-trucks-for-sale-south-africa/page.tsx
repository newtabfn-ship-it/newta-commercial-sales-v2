...
export const metadata: Metadata = {
  title:
    "3 Ton Trucks for Sale South Africa | NEWTA Commercial Sales",

  description:
    "Browse 3 ton trucks for sale in South Africa through NEWTA Commercial Sales. View available 3 ton commercial trucks with specifications, photographs, pricing and enquiry information.",
  ...
  openGraph: {
    ...
    description:
      "Browse 3 ton trucks currently available through NEWTA Commercial Sales across South Africa. View specifications, photographs, pricing and enquiry information.",
  ...
  twitter: {
    ...
    description:
      "Browse available 3 ton trucks through NEWTA Commercial Sales across South Africa.",
  },
};

export default async function ThreeTonTrucksPage() {
  await connectDB();
  ...
  const structuredData = {
    ...
    description:
      "3 ton trucks for sale through NEWTA Commercial Sales across South Africa.",
        ...
        <section className="bg-gradient-to-r from-green-950 via-green-900 to-green-800 text-white">
          ...
          <div className="mx-auto max-w-7xl px-6 py-20">
            ...
            <p className="mt-6 max-w-4xl text-lg leading-8 text-gray-200 md:text-xl">
              Browse 3 ton trucks currently available through
              NEWTA Commercial Sales. View truck specifications,
              photographs, pricing and enquiry information for
              available 3 ton commercial trucks across South Africa.
            </p>
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-5 text-lg leading-8 text-gray-600">
              ...
              through Private Treaty Sales. Our 3 ton truck
            ...
            <p className="mt-5 text-lg leading-8 text-gray-600">
              Browse the current 3 ton trucks below and select an
          ...
          {equipment.length > 0 ? (
            ...
            <div className="mt-12 rounded-2xl border bg-white p-10 text-center shadow-sm">
              ...
              <p className="mt-3 text-gray-600">
                Please check back soon for new 3 ton truck
                listings.
              </p>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <h3 className="text-xl font-bold text-[#0B2F24]">
                  3 Ton Commercial Trucks
                </h3>

                <p className="mt-3 text-gray-600">
                  Browse available 3 ton commercial trucks suitable
              ...
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <p className="mt-3 text-gray-600">
                  ...
                  about an available 3 ton truck and receive
        ...
        <section className="bg-[#0B2F24] text-white">
          ...
          <div className="mx-auto max-w-7xl px-6 py-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300">
              ...
              for a particular 3 ton truck or want more information
