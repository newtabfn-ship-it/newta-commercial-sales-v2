...
export const metadata: Metadata = {
  title:
    "Compressors for Sale South Africa | NEWTA Commercial Sales",

  description:
    "Browse compressors for sale in South Africa through NEWTA Commercial Sales. View available compressors, specifications, images, pricing and enquiry information.",

  alternates: {
    canonical:
      "https://newtacommercialsales.com/equipment/compressors-for-sale-south-africa",
  },
  ...
  openGraph: {
    title:
      "Compressors for Sale South Africa | NEWTA Commercial Sales",
    description:
      "Browse compressors currently available through NEWTA Commercial Sales across South Africa.",
    url:
      "https://newtacommercialsales.com/equipment/compressors-for-sale-south-africa",
    type: "website",
  ...
  twitter: {
    ...
    title:
      "Compressors for Sale South Africa | NEWTA Commercial Sales",
    description:
      "Browse available compressors through NEWTA Commercial Sales.",
  },
};

export default async function CompressorsForSalePage() {
  await connectDB();
  ...
  const compressors = plantMachinery?.subcategories.find(
    (subcategory) => subcategory.slug === "compressors"
  );

  const equipment = await Equipment.find({
    category: plantMachinery?.name,
    subcategory: compressors?.name,
    status: "Available",
  })
    .sort({ createdAt: -1 })
    .lean();
  ...
  const structuredData = {
    ...
    name: "Compressors for Sale South Africa",

    description:
      "Compressors for sale through NEWTA Commercial Sales.",
          ...
          <div className="mx-auto max-w-7xl px-6 py-20">
            ...
            >
              ...
              <span className="text-[#D4AF37]">
                Compressors for Sale South Africa
              </span>
            </nav>
            ...
            <p className="mt-6 max-w-4xl text-lg leading-8 text-gray-200 md:text-xl">
              Browse compressors currently available through NEWTA
              Commercial Sales. View specifications, photographs,
              pricing and enquiry information for available
              compressors across South Africa.
            </p>
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-5 text-lg leading-8 text-gray-600">
              Browse current compressor listings available through
              NEWTA Commercial Sales. View available specifications,
              photographs, pricing and enquiry information for each
              asset.
            </p>
          </div>
          ...
          {equipment.length > 0 ? (
            ...
            <div className="mt-12 rounded-2xl border bg-white p-10 text-center shadow-sm">
              <h2 className="text-2xl font-bold text-[#0B2F24]">
                No compressors currently available
              </h2>

              <p className="mt-3 text-gray-600">
                Please check back soon for new compressor listings.
              </p>
        ...
        <section className="border-t bg-white">
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <p className="mt-5 max-w-4xl text-lg leading-8 text-gray-600">
              Browse compressors available through NEWTA Commercial
              Sales and contact us if you are looking for a specific
              compressor or industrial asset.
            </p>
        ...
        <section className="bg-[#0B2F24] text-white">
          <div className="mx-auto max-w-7xl px-6 py-16 text-center">
            ...
            <h2 className="text-3xl font-bold md:text-4xl">
              Looking for a Specific Compressor?
            </h2>

            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300">
              Contact NEWTA Commercial Sales if you are looking for
              a particular compressor or want more information about
              an available asset.
            </p>
