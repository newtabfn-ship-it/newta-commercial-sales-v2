...
export const metadata: Metadata = {
  title:
    "Flatdeck Trucks for Sale South Africa | NEWTA Commercial Sales",

  description:
    "Browse flatdeck trucks for sale in South Africa through NEWTA Commercial Sales. View available flatbed and flat deck trucks with specifications, photographs, pricing and enquiry information.",

  alternates: {
    canonical:
      "https://newtacommercialsales.com/equipment/flatdeck-trucks-for-sale-south-africa",
  },
  ...
  openGraph: {
    ...
    description:
      "Browse flatdeck trucks currently available through NEWTA Commercial Sales across South Africa. View truck specifications, photographs, pricing and enquiry information.",
  ...
  twitter: {
    ...
    description:
      "Browse available flatdeck trucks through NEWTA Commercial Sales across South Africa.",
  },
};

export default async function FlatdeckTrucksPage() {
  await connectDB();
  ...
  const flatdeckTrucks = commercialVehicles?.subcategories.find(
    (subcategory) => subcategory.slug === "flatdeck-trucks"
  );

  const equipment = await Equipment.find({
    category: commercialVehicles?.name,
    subcategory: flatdeckTrucks?.name,
    status: "Available",
  })
    .sort({ createdAt: -1 })
    .lean();
  ...
  const structuredData = {
    ...
    name: "Flatdeck Trucks for Sale South Africa",

    description:
      "Flatdeck trucks for sale through NEWTA Commercial Sales across South Africa.",
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="max-w-4xl">
            ...
            <h2 className="text-3xl font-bold text-[#0B2F24] md:text-4xl">
              Flatdeck Trucks for Sale
            </h2>

            <p className="mt-5 text-lg leading-8 text-gray-600">
              NEWTA Commercial Sales offers commercial vehicles
              through Private Treaty Sales. Our flatdeck truck
            ...
            <p className="mt-5 text-lg leading-8 text-gray-600">
              Flatdeck trucks provide an open load area suitable
              for transporting machinery, building materials,
              equipment, pallets and other commercial loads.
              Browse the current listings below to find an
              available truck.
            </p>
          ...
          {equipment.length > 0 ? (
            ...
            <div className="mt-12 rounded-2xl border bg-white p-10 text-center shadow-sm">
              ...
              <h2 className="text-2xl font-bold text-[#0B2F24]">
                No flatdeck trucks currently available
              </h2>

              <p className="mt-3 text-gray-600">
                Please check back soon for new flatdeck truck
                listings.
              </p>
          ...
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <p className="mt-3 text-gray-600">
                  Flatdeck trucks provide an open platform for
                  transporting a wide range of commercial loads,
              ...
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <p className="mt-3 text-gray-600">
                  ...
                  about an available flatdeck truck and receive
        ...
        <section className="bg-[#0B2F24] text-white">
          ...
          <div className="mx-auto max-w-7xl px-6 py-16 text-center">
            ...
            <h2 className="text-3xl font-bold md:text-4xl">
              Looking for a Flatdeck Truck?
            </h2>

            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300">
              Contact NEWTA Commercial Sales if you are looking
              for a particular flatdeck truck or want more
