...
const pageUrl =
  "https://newtacommercialsales.com/equipment/flatdeck-trailers-for-sale-south-africa";

export const metadata: Metadata = {
  title: "Flatdeck Trailers for Sale South Africa | NEWTA Commercial Sales",

  description:
    "Flatdeck trailers for sale in South Africa through NEWTA Commercial Sales. Browse available flatdeck trailers for machinery, equipment, building materials, agricultural loads and general commercial freight.",
  ...
  openGraph: {
    ...
    description:
      "Browse flatdeck trailers for sale through NEWTA Commercial Sales, including standard and combination trailer configurations.",
  ...
  twitter: {
    ...
    description:
      "Browse available flatdeck trailers through NEWTA Commercial Sales.",
  },
};

export default async function FlatdeckTrailersForSalePage() {
  await connectDB();
  ...
  /*
   * Flatdeck trailers may eventually have their own category in
  ...
  const flatdeckEquipment = equipment.filter((item: any) => {
    ...
    return searchableText.includes("flatdeck");
  });
  ...
  const structuredData = {
    ...
    name: "Flatdeck Trailers for Sale South Africa",

    description:
      "Flatdeck trailers for sale through NEWTA Commercial Sales, including standard and combination trailer configurations.",
    ...
    mainEntity: {
      ...
      numberOfItems: flatdeckEquipment.length,

      itemListElement: flatdeckEquipment.map((item: any, index: number) => ({
        "@type": "ListItem",
      ...
      <main className="min-h-screen bg-[#FAF8F2]">
        ...
        <section className="bg-gradient-to-r from-green-950 via-green-900 to-green-800 text-white">
          <div className="mx-auto max-w-7xl px-6 py-20">
            ...
            <h1 className="mt-6 max-w-5xl text-4xl font-extrabold leading-tight md:text-6xl">
              Flatdeck Trailers for Sale South Africa
            </h1>

            <p className="mt-6 max-w-4xl text-lg leading-8 text-gray-200 md:text-xl">
              Browse flatdeck trailers for sale through NEWTA
              Commercial Sales. Flatdeck trailers provide an open,
              practical platform for transporting machinery, equipment,
              building materials, agricultural loads and general
              commercial freight.
            </p>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          <div className="max-w-4xl">
            <h2 className="text-3xl font-bold text-[#0B2F24] md:text-4xl">
              Flatdeck Trailers for Sale
            </h2>

            <p className="mt-5 text-lg leading-8 text-gray-600">
              Flatdeck trailers are designed around an open,
              unobstructed loading platform, making them suitable for
              transporting a wide range of commercial loads. Their
              open deck allows equipment, machinery, building
              materials and other large items to be loaded according
              to the trailer configuration and available payload.
            </p>

            <p className="mt-5 text-lg leading-8 text-gray-600">
              NEWTA Commercial Sales can offer different flatdeck
          ...
          <div className="mt-14">
            <h2 className="text-3xl font-bold text-[#0B2F24]">
              Common Uses for Flatdeck Trailers
            </h2>

            <p className="mt-4 max-w-3xl text-lg leading-8 text-gray-600">
              Flatdeck trailers can be used across construction,
        ...
        <section className="border-y bg-white">
          <div className="mx-auto max-w-7xl px-6 py-16">
            <div className="max-w-4xl">
              <h2 className="text-3xl font-bold text-[#0B2F24] md:text-4xl">
                Flatdeck Trailer Configurations
              </h2>

              <p className="mt-5 text-lg leading-8 text-gray-600">
                Flatdeck trailers are available in different
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-2">
              <div className="rounded-2xl border bg-[#FAF8F2] p-7 shadow-sm">
                <h3 className="text-2xl font-bold text-[#0B2F24]">
                  Standard Flatdeck Trailers
                </h3>

                <p className="mt-4 leading-7 text-gray-600">
                  Single flatdeck trailers provide an open loading
                  platform for transporting equipment, machinery,
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          <div className="max-w-4xl">
            <h2 className="text-3xl font-bold text-[#0B2F24] md:text-4xl">
              Flatdeck Trailers Currently Available
            </h2>
          ...
          {flatdeckEquipment.length > 0 ? (
            <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {flatdeckEquipment.map((item: any) => (
                <EquipmentCard
            ...
            <div className="mt-12 rounded-2xl border bg-white p-10 text-center shadow-sm">
              <h2 className="text-2xl font-bold text-[#0B2F24]">
                No flatdeck trailers currently available
              </h2>

              <p className="mt-3 text-gray-600">
                Please check back soon for new flatdeck trailer
                listings.
              </p>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <p className="mt-3 leading-7 text-gray-600">
                  The open deck design provides practical access for
                  loading a wide range of commercial equipment,
              ...
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <p className="mt-3 leading-7 text-gray-600">
                  Flatdeck trailers can be found in different
              ...
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <p className="mt-3 leading-7 text-gray-600">
                  ...
                  available flatdeck trailer or another commercial
                  asset.
                </p>
              </div>
            </div>
        ...
        <section className="bg-[#0B2F24] text-white">
          <div className="mx-auto max-w-7xl px-6 py-16 text-center">
            <h2 className="text-3xl font-bold md:text-4xl">
              Looking for a Flatdeck Trailer?
            </h2>

            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300">
              Contact NEWTA Commercial Sales if you are looking for a
              particular flatdeck trailer or want more information
