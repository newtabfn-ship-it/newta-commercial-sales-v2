...
export const metadata: Metadata = {
  title:
    "10 Ton Trucks for Sale South Africa | NEWTA Commercial Sales",

  description:
    "Browse 10 ton trucks for sale in South Africa through NEWTA Commercial Sales. View available 10 ton commercial trucks with specifications, photographs, pricing and enquiry information.",

  alternates: {
    canonical:
      "https://newtacommercialsales.com/equipment/10-ton-trucks-for-sale-south-africa",
  },
  ...
  openGraph: {
    ...
    description:
      "Browse  ton trucks currently available through NEWTA Commercial Sales across South Africa. View specifications, photographs, pricing and enquiry information.",
  ...
  twitter: {
    ...
    description:
      "Browse available 10 ton trucks through NEWTA Commercial Sales across South Africa.",
  },
};

export default async function TenTonTrucksPage() {
  await connectDB();
  ...
  const tenTonTrucks = commercialVehicles?.subcategories.find(
    (subcategory) => subcategory.slug === "10-ton-trucks"
  );

  const equipment = await Equipment.find({
    category: commercialVehicles?.name,
    subcategory: tenTonTrucks?.name,
    status: "Available",
  })
    .sort({ createdAt: -1 })
    .lean();
  ...
  const structuredData = {
    ...
    name: "10 Ton Trucks for Sale South Africa",

    description:
      "10 ton trucks for sale through NEWTA Commercial Sales across South Africa.",
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="max-w-4xl">
            ...
            <h2 className="text-3xl font-bold text-[#0B2F24] md:text-4xl">
              10 Ton Trucks for Sale
            </h2>

            <p className="mt-5 text-lg leading-8 text-gray-600">
              NEWTA Commercial Sales offers commercial vehicles
              through Private Treaty Sales. Our 10 ton truck
            ...
            <p className="mt-5 text-lg leading-8 text-gray-600">
              Browse the current 10 ton trucks below and select an
          ...
          {equipment.length > 0 ? (
            ...
            <div className="mt-12 rounded-2xl border bg-white p-10 text-center shadow-sm">
              ...
              <h2 className="text-2xl font-bold text-[#0B2F24]">
                No 10 ton trucks currently available
              </h2>

              <p className="mt-3 text-gray-600">
                Please check back soon for new 10 ton truck
                listings.
              </p>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              ...
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <h3 className="text-xl font-bold text-[#0B2F24]">
                  10 Ton Commercial Trucks
                </h3>

                <p className="mt-3 text-gray-600">
                  Browse available 10 ton commercial trucks suitable
              ...
              <div className="rounded-2xl border p-6 shadow-sm">
                ...
                <p className="mt-3 text-gray-600">
                  ...
                  about an available 10 ton truck and receive
        ...
        <section className="bg-[#0B2F24] text-white">
          ...
          <div className="mx-auto max-w-7xl px-6 py-16 text-center">
            ...
            <h2 className="text-3xl font-bold md:text-4xl">
              Looking for a 10 Ton Truck?
            </h2>

            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300">
              Contact NEWTA Commercial Sales if you are looking
              for a particular 10 ton truck or want more information
