...
export const metadata: Metadata = {
  title: "10 Ton Trucks for Sale South Africa | NEWTA Commercial Sales",

  description:
    "Browse 10 ton trucks for sale in South Africa through NEWTA Commercial Sales. View available commercial trucks including dropside, flatdeck and other 10 ton trucks offered through Private Treaty Sales.",
  ...
  openGraph: {
    ...
    description:
      "Browse 10 ton trucks for sale in South Africa through NEWTA Commercial Sales.",
...
export default async function TenTonTrucksForSaleSouthAfrica() {
  await connectDB();
  ...
  const structuredData = {
    ...
    description:
      "10 ton commercial trucks for sale through NEWTA Commercial Sales.",
        ...
        <section className="bg-gradient-to-r from-green-950 via-green-900 to-green-800 text-white">
          ...
          <div className="mx-auto max-w-7xl px-6 py-20">
            ...
            <p className="mt-6 max-w-4xl text-lg leading-8 text-gray-200 md:text-xl">
              Browse 10 ton trucks for sale in South Africa through
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-5 text-lg leading-8 text-gray-600">
              View current 10 ton truck listings available through
          ...
          {equipment.length > 0 ? (
            ...
            <div className="mt-12 rounded-2xl border bg-white p-10 text-center shadow-sm">
              ...
              <p className="mt-3 text-gray-600">
                We do not currently have a 10 ton truck listed for
        ...
        <section className="border-t bg-white">
          ...
          <div className="mx-auto max-w-7xl px-6 py-16">
            ...
            <p className="mt-4 max-w-4xl text-lg leading-8 text-gray-600">
              Depending on availability, 10 ton trucks may be available
            ...
            <div className="max-w-4xl">
              ...
              <h2 className="text-3xl font-bold text-[#0B2F24] md:text-4xl">
                What Are 10 Ton Trucks?
                             ...
                             <p className="mt-5 text-lg leading-8 text-gray-600">
  10 ton trucks are heavy-duty commercial vehicles designed for
  ...
  specification, 10 ton trucks can be used for a wide range of
        ...
        <section className="bg-[#0B2F24] text-white">
          ...
          <div className="mx-auto max-w-7xl px-6 py-16 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-300">
              If you are looking for a particular 10 ton truck, body
